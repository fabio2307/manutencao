 ...
 * @author Fábio
 */
public class TelaPrevSemestral1 extends javax.swing.JInternalFrame {
...
//    int id2 = 0;
    ...
    private void ativar() {
        situacao = "Aberta";
        String sql = "select * from form_eletrica_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ?";
        try {
    ...
    private void ativar1() {
        situacao = "Aberta";
        String sql = "select * from form_hidraulica_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
    ...
    private void ativar2() {
        situacao = "Aberta";
        String sql = "select * from form_civil_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
    ...
    private void ativar3() {
        situacao = "Aberta";
        String sql = "select * from form_refrigeracao_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
    ...
    private void filtro_ele_sem() {
        ...
        String sql = "select id_form_ele_semestral as 'N° Preventiva', iduser as 'R.E', nome_prev as Técnico, tipo_prev as 'Preventiva', setor_prev as Setor, nome_equi_set as Equipamento, cod_equi_set as 'Cod. Equipamento', situacao_prev as 'Situação', tempo_dis as Distribuição from  form_eletrica_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
...
//            txtPesqEle.setEnabled(true);
    ...
    private void filtro_hid_sem() {
        situacao = "Aberta";
        String sql = "select id_hidraulica_semestral as 'N° Preventiva', iduser as 'R.E', nome_prev as Técnico, tipo_prev as 'Preventiva', setor_prev as Setor, nome_equi_set as Equipamento, cod_equi_set as 'Cod. Equipamento', situacao_prev as 'Situação', tempo_dis as Distribuição from  form_hidraulica_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
...
//            txtPesqHid.setEnabled(true);
    ...
    private void filtro_civ_sem() {
        situacao = "Aberta";
        String sql = "select id_civil_semestral as 'N° Preventiva', iduser as 'R.E', nome_prev as Técnico, tipo_prev as 'Preventiva', setor_prev as Setor, nome_equi_set as Equipamento, cod_equi_set as 'Cod. Equipamento', situacao_prev as 'Situação', tempo_dis as Distribuição from  form_civil_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
...
//            txtPesqCiv.setEnabled(true);
    ...
    private void filtro_ref_sem() {
        situacao = "Aberta";
        String sql = "select id_refrigeracao_semestral as 'N° Preventiva', iduser as 'R.E', nome_prev as Técnico, tipo_prev as 'Preventiva', setor_prev as Setor, nome_equi_set as Equipamento, cod_equi_set as 'Cod. Equipamento', situacao_prev as 'Situação', tempo_dis as Distribuição from form_refrigeracao_semestral where data_prev  > (NOW() - INTERVAL 20 DAY) and iduser = ?  and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
...
//            txtPesqRef.setEnabled(true);
    ...
    private void eletrica_sem() {
        situacao = "Aberta";
        String sql = "select count(*) from form_eletrica_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
    ...
    private void civil_sem() {
        ...
        String sql = "select count(*) from form_civil_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
    ...
    private void hidraulica_sem() {
        ...
        String sql = "select count(*) from form_hidraulica_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
    ...
    private void refrigeracao_sem() {
        ...
        String sql = "select count(*) from form_refrigeracao_semestral where data_prev  > (NOW() - INTERVAL 30 DAY) and iduser = ?  and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao);
