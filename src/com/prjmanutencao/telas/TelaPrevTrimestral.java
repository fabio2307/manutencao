 ...
 * @author Fábio
 */
public class TelaPrevTrimestral extends javax.swing.JInternalFrame {
...
//    int id2 = 0;
    ...
    private void ativar() {
        String sql = "select * from form_eletrica_trimestral where iduser = ?";
        try {
    ...
    private void ativar1() {
        String sql = "select * from form_hidraulica_trimestral where iduser = ?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            rs = pst.executeQuery();
...
//
    ...
    private void ativar2() {
        String sql = "select * from form_civil_trimestral where iduser = ?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            rs = pst.executeQuery();
    ...
    private void ativar3() {
        String sql = "select * from form_refrigeracao_trimestral where iduser = ?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            rs = pst.executeQuery();
...
//
    ...
    private void filtro_ele_tri() {
        ...
        String sql = "select id_form_ele_trimestral as 'N° Preventiva', iduser as 'R.E', nome_prev as Técnico, tipo_prev as 'Preventiva', setor_prev as Setor, nome_equi_set as Equipamento, cod_equi_set as 'Cod. Equipamento', tempo_dis as Distribuição from  form_eletrica_trimestral where iduser = ? and situacao_prev is null or iduser = ? and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, id);
...
//
    ...
    private void filtro_hid_tri() {
        situacao = "Aberta";
        String sql = "select id_hidraulica_trimestral as 'N° Preventiva', iduser as 'R.E', nome_prev as Técnico, tipo_prev as 'Preventiva', setor_prev as Setor, nome_equi_set as Equipamento, cod_equi_set as 'Cod. Equipamento', tempo_dis as Distribuição from form_hidraulica_trimestral where iduser = ? and situacao_prev is null or iduser = ? and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, id);
...
//
    ...
    private void filtro_civ_tri() {
        situacao = "Aberta";
        String sql = "select id_civil_trimestral as 'N° Preventiva', iduser as 'R.E', nome_prev as Técnico, tipo_prev as 'Preventiva', setor_prev as Setor, nome_equi_set as Equipamento, cod_equi_set as 'Cod. Equipamento', tempo_dis as Distribuição from  form_civil_trimestral where iduser = ? and situacao_prev is null or iduser = ? and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, id);
...
//
    ...
    private void filtro_ref_tri() {
        situacao = "Aberta";
        String sql = "select id_refrigeracao_trimestral as 'N° Preventiva', iduser as 'R.E', nome_prev as Técnico, tipo_prev as 'Preventiva', setor_prev as Setor, nome_equi_set as Equipamento, cod_equi_set as 'Cod. Equipamento', tempo_dis as Distribuição from form_refrigeracao_trimestral where iduser = ? and situacao_prev is null or iduser = ? and situacao_prev = ? ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, id);
...
//
    ...
    private void eletrica_tri() {
        ...
        String sql = "select count(*) from form_eletrica_trimestral where iduser = ? and situacao_prev = ? or iduser = ? and situacao_prev is null ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
...
//
    ...
    private void civil_tri() {
        ...
        String sql = "select count(*) from form_civil_trimestral where iduser = ? and situacao_prev = ? or iduser = ? and situacao_prev is null ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao1);
...
//
    ...
    private void hidraulica_tri() {
        ...
        String sql = "select count(*) from form_hidraulica_trimestral where iduser = ? and situacao_prev = ? or iduser = ? and situacao_prev is null ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao1);
...
//
    ...
    private void refrigeracao_tri() {
        ...
        String sql = "select count(*) from form_refrigeracao_trimestral where iduser = ? and situacao_prev = ? or iduser = ? and situacao_prev is null ";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, id);
            pst.setString(2, situacao1);
    ...
    private void select_preventiva() {
        ...
        if (preventiva.equals("Eletrica - Trimestral")) {
            ...
            if (confirma == JOptionPane.YES_OPTION) {
                ...
                prev_men.txtDatIni4.setText(format);
                prev_men.prev_ini();
        ...
        if (preventiva.equals("Hidráulica - Trimestral")) {
            ...
            if (confirma == JOptionPane.YES_OPTION) {
                ...
                prev_men.txtDatIni5.setText(format);
                prev_men.prev_ini();
        ...
        if (preventiva.equals("Civil - Trimestral")) {
            ...
            if (confirma == JOptionPane.YES_OPTION) {
                ...
                prev_men.txtDatIni6.setText(format);
                prev_men.prev_ini();
        ...
        if (preventiva.equals("Refrigeração - Trimestral")) {
            ...
            if (confirma == JOptionPane.YES_OPTION) {
                ...
                prev_men.txtDatIni7.setText(format);
                prev_men.prev_ini();
